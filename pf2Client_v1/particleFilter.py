...
class filtroParticulas():
    ...
    def weights_calculation(self, LINEsens, DISTsens):
        ...
        # Metodo 2
            ...
            self.calculateDistanceEndpoints(centerDIST, leftDIST, rightDIST, backDIST) # Ativar para metodo 2 (Apenas esta função gasta +20 ms)

            for i,particula in enumerate(self.particulas): 
                sensorDIST_center_endpointleft_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_center_endpointleft_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_center_endpointleft_y)
                )
                sensorDIST_center_endpointcenter_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_center_endpointcenter_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_center_endpointcenter_y)
                )
                sensorDIST_center_endpointright_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_center_endpointright_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_center_endpointright_y)
                )
                
                sensorDIST_left_endpointleft_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_left_endpointleft_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_left_endpointleft_y)
                )
                sensorDIST_left_endpointcenter_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_left_endpointcenter_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_left_endpointcenter_y)
                )
                sensorDIST_left_endpointright_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_left_endpointright_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_left_endpointright_y)
                )

                sensorDIST_right_endpointleft_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_right_endpointleft_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_right_endpointleft_y)
                )
                sensorDIST_right_endpointcenter_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_right_endpointcenter_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_right_endpointcenter_y)
                )
                sensorDIST_right_endpointright_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_right_endpointright_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_right_endpointright_y)
                )

                sensorDIST_back_endpointleft_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_back_endpointleft_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_back_endpointleft_y)
                )
                sensorDIST_back_endpointcenter_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_back_endpointcenter_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_back_endpointcenter_y)
                )
                sensorDIST_back_endpointright_index = (
                    int(self.map_scale_factor*self.mapmax_x+self.map_scale_factor*particula.sensorDIST_back_endpointright_x),
                    int(self.map_scale_factor*self.mapmax_y+self.map_scale_factor*particula.sensorDIST_back_endpointright_y)
                )
        ...
        # Metodo 3
            ...
            for i,particula in enumerate(self.particulas): 
                ...
                distmappartvalue = self.distance_map_full[
                    self.map_scale_factor*self.mapmax_y + self.map_scale_factor*int(particula.y),
                    self.map_scale_factor*self.mapmax_x + self.map_scale_factor*int(particula.x)
                ]
